...
public class JWTServiceConfiguration {
	...
	private static final String SECRET_KEY = "Zr4u7xADGKaPdRgUkXp2s5v8yBEHMbQeThVmYq3t6w9zCFJNcRfU";
	...
	public boolean isTokenValid(String token, UserDetails userDetails) {
		final String identificador = this.extractUsername(token);
		return (identificador.equals(userDetails.getUsername()) && !this.isTokenExpired(token));
	}
